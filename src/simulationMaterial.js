...
class SimulationMaterial extends THREE.ShaderMaterial {
  constructor(size = 512) {
    ...
    super({
      ...
      fragmentShader: `
        precision mediump float;
        precision mediump sampler2D; // Explicit for texture opt
        uniform float uTime;
        uniform float uFrequency;
        uniform sampler2D positions;
        varying vec2 vUv;

        // Optimized Simplex Noise (snoise) - tightened mod/permute
        ...
        // snoiseVec3 and curlNoise unchanged, as they're tight
        ${snoiseVec3}
        ${curlNoise}

        // Use optimized cnoise or replace with snoise for mix
